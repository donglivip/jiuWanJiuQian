<template>
	<view class="wrapper">
		<view class="main">
			<view class="main-one">
				<view class="one-top">
					<image src="https://9w9q.oss-cn-shanghai.aliyuncs.com/img/app_img/wx_img/baojia.png" mode=""></image>
					<view class="one-text">报价成功</view>
				</view>
				<view class="one-bottom">
					<view class="b-box">
						<view class="l-top">
							<image src="https://9w9q.oss-cn-shanghai.aliyuncs.com/img/app_img/wx_img/touxiang.png" mode=""></image>
							<view class="l-text">李晓明</view>
						</view>
						<view class="b-bott" @tap="opennew02('index')">接着找商机</view>
					</view>
					<view class="b-box">
						<view class="l-top">
							<image src="https://9w9q.oss-cn-shanghai.aliyuncs.com/img/app_img/wx_img/baoxiang.png" mode=""></image>
							<view class="l-text">15255550521</view>
						</view>
						<view class="b-bott b-zi" @tap="telphone()">拨打电话</view>
					</view>
				</view>
			</view>
			<view class="main-box"  @tap="opennew('qiugouxiangqing2')">
